...
import com.nureddinelmas.articles.view.FeedFragmentDirections
...
class ArticleAdapter(private val articleList: ArrayList<Article>) :
	...
	override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
		...
		holder.view.linearLayoutItemArticle.setOnClickListener {
			val action = FeedFragmentDirections.actionFeedFragmentToArticleFragment(articleList[position], false)
